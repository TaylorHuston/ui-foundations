...
See [Library Adoption](./docs/library-adoption.md) for imports, wrappers, CSS layering, override hooks, and the pre-1.0 compatibility policy. Registry publication is not active yet and remains a separately authorized release action.
